...
public class JavaArray2 {
	...
	public static void main(String[] args) {
		...
		// 정수 7개 입력한뒤 모두 출력 하세요.
		
//		int[] arr = new int[7]; // 7의크기 배열( 7개 공간)
//		
...
//		}
		...
		// a와 b 배열의 데이터를 totla 배열에 저장하기
		// a 배열의 값 먼저 저장하고 이어서 b 배열의값 저장 될수 있게!!
		// 저장한뒤에 total배열 값 출력
...
//		
//		// name -> john 문자로 저장
//		// 문자열은 배열이 지만 char 배열로는 온전한 문자열 입력이 어렵다.
...
//		
		...
		System.out.println(  "Cb".compareTo("Ca")  );
